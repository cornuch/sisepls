...
3. **The functionnalities**
   ...
   3.1- \textcolor{blue}{train_test_splits} : The train_test_splits function takes a data frame and returns two data frames (one data frame containing the training data set
